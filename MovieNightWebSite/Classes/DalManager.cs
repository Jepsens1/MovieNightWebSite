...
namespace MovieNightWebSite
{
    class DalManager
    {
        ...
        public static Movie InsertMovie(Movie movie)
        {
            ...
            string Insertmovie = "INSERT INTO Movie(Title, Year, Genre) VALUES (@Title, @Year, @Genre)";
            using (SqlConnection connection = new SqlConnection(connstring))
            {
                connection.Open();
        ...
        public static List<Movie> GetMovies()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connstring))
            {
                ...
                while (rdr.Read())
                {
                    ...
                    Movie m = new Movie(id, title, year, genre);
                    moviesList.Add(m);
                }
        ...
        public static List<Movie> GetMovieTitle(string search)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connstring))
            {
                ...
                while (rdr.Read())
                {
                    ...
                    //Creates movie object, and adds to list
                    Movie movietitle = new Movie(id, title, year, genre);
        ...
        public static List<Movie> GetMovieGenreSearch(string search)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connstring))
            {
                ...
                while (rdr.Read())
                {
                    ...
                    //Creates movie object, and adds to list
                    Movie moviegenre = new Movie(id, title, year, genre);
